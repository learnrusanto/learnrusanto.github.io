...
(function() {
  ...
  Esperanto = {
    alphabet: {
      upperCase: ['A', 'Á', 'B', 'C', 'D', 'E', 'É', 'F', 'G', 'H', 'I', 'Í', 'J', 'Ž', 'K', 'L', 'M', 'N', 'O', 'Ó', 'P', 'R', 'S', 'Š', 'T', 'U', 'Ú', 'V', 'Z'],
      lowerCase: ['a', 'á', 'b', 'c', 'd', 'e', 'é', 'f', 'g', 'h', 'i', 'í', 'j', 'ž', 'k', 'l', 'm', 'n', 'o', 'ó', 'p', 'r', 's', 'š', 't', 'u', 'ú', 'v', 'z']
    }
  };
  ...
  Cyrillic = {
    alphabet: {
      upperCase: ['А', 'А́', 'Б', 'Ч', 'Д', 'Е', 'Е́', 'Ф', 'Г', 'Х', 'И', 'И́', 'Ј', 'Ж', 'К', 'Л', 'М', 'Н', 'О', 'О́', 'П', 'Р', 'С', 'Ш', 'Т', 'У', 'У́', 'В', 'З'],
      lowerCase: ['а', 'а́', 'б', 'ч', 'д', 'е', 'е́', 'ф', 'г', 'х', 'и', 'и́', 'ј', 'ж', 'к', 'л', 'м', 'н', 'о', 'о́', 'п', 'р', 'с', 'ш', 'т', 'у', 'у́', 'в', 'з']
    }
  };
